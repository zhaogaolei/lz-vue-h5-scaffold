<template>
  <div class="zmjd-swipe">
    <div
      class="zmjd-swipe-items-wrap"
      ref="wrap"
    >
      <slot />
    </div>
    <div
      class="zmjd-swipe-indicators"
      v-show="showIndicators"
    >
      <div
        class="zmjd-swipe-indicator"
...
const COMPONENT_NAME = 'zmjd-swipe'
export default {
  name: COMPONENT_NAME,
  created () {
    this.dragState = {}
